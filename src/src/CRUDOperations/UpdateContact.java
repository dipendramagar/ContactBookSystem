...
// Class for updating an existing contact (UPDATE operation)
public class UpdateContact extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        btnUpdate.setOnAction(event -> {
            try {
                // Create Contact object with updated values
                ...
                // Call update method
                boolean result = new DBConnection().update(contact);
        ...
        // SEARCH BUTTON (load existing data before update)
        ...
        pane.getChildren().addAll(btnSearch, btnUpdate, btnClose, lblStatus);
